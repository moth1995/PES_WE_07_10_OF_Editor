...
class OptionFile:
    ...
    def teams_names(self):       
        ...
        return self.nations[:Team.total_nations] + classic_teams_names + japan_n_team_names + EDITED_TEAM_NAMES + self.clubs_names[:Team.total_clubs] + japan_c_team_names + ML_TEAM_NAME + SHOP_TEAM_NAMES + ML_TEAM_NAMES_EXTRAS
